...
public abstract class DatabaseColumn implements BaseColumns {
	...
	private final static String TAG="DatabaseColumn";
	/**
	 * The identifier to indicate a specific ContentProvider
	 */
	public static final String AUTHORITY = "com.example.wgo.provider";
	/**
	 * The database's name
	 */
	public static final String DATABASE_NAME = "jizhangben.db";
	/**
	 ...
	 */
	public static final String[] SUBCLASSES = new String[] { "com.example.db.ShouzhiColumn","com.example.db.UserColumn"};
	...
	private static final String getTableCreator(String tableName,
		...
		creator.append(")");
		Log.d(TAG, "creator.toString()------>"+creator.toString());
